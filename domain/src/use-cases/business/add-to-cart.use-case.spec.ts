...
describe('Add To Cart Use Case', () => {
    ...
    let maintenancePlanRepository: InMemoryMaintenancePlanRepository;
    let cartRepository: InMemoryCartRepository;
    let addToCartUseCase: AddToCartUseCase;
    let clientUser: User, client: Client;
    let service: Service, plan: MaintenancePlan;
    ...
    it('should update an existing active cart', async () => {
        ...
        const newService: Service = { id: 'service-2', name: 'Web Avanzada', price: 1000, categoryId: 'cat-1', description: '...' };
