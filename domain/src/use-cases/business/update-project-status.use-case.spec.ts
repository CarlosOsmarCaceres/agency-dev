...
describe('Update Project Status Use Case', () => {
    ...
    let updateProjectStatusUseCase: UpdateProjectStatusUseCase;

    let adminUser: User, salespersonUser: User, clientUser: User;
    let project: Project;
    ...
    it('should throw an error if the new status is invalid', async () => {
        const input = { actingUserId: 'admin-1', projectId: 'proj-1', newStatus: 'INVALID_STATUS' as any }; // Force invalid type for test
