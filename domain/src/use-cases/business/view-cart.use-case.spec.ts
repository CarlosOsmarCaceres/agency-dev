...
describe('View Cart Use Case', () => {
    ...
    let planRepository: InMemoryMaintenancePlanRepository;
    let cartRepository: InMemoryCartRepository;
    let viewCartUseCase: ViewCartUseCase;
    let clientUser: User, client: Client, service: Service, plan: MaintenancePlan, cart: Cart;
