...
describe('List Categories Use Case', () => {
    ...
    it('should return a list of all categories', async () => {
        ...
        const category1 = { id: 'cat-1', name: 'Web Corporativa', description: '...' };
        const category2 = { id: 'cat-2', name: 'Tienda Online', description: '...' };
...
//# sourceMappingURL=list-categories.use-case.spec.js.map