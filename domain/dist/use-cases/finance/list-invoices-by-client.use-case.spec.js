...
describe('List Invoices By Client Use Case', () => {
    ...
    let listInvoicesByClientUseCase;
    let adminUser, salespersonUser, clientUser1, clientUser2;
    let client1, client2;
    let invoice1, invoice2; // Facturas para client1
    beforeEach(async () => {
...
//# sourceMappingURL=list-invoices-by-client.use-case.spec.js.map