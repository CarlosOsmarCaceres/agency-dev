...
import { CartStatuses } from '../../../../../domain/dist/entities/business/cart.js';
const prisma = new PrismaClient();
// --- Funciones de Traducción ---
/**
 * Traduce el estado del carrito de Prisma (DB) al Dominio (Negocio)
 */
function toDomainCartStatus(prismaStatus) {
    switch (prismaStatus) {
        case 'ACTIVE':
 ...
 */
function toPrismaCartStatus(domainStatus) {
    switch (domainStatus) {
 ...
 */
function toDomainCart(prismaCart) {
    return {
        id: prismaCart.id,
