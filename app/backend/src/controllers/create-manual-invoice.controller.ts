...
import { CreateManualInvoiceInput } from '../../../../domain/dist/use-cases/finance/create-manual-invoice.use-case.js';

export const createManualInvoiceController = async (req: Request, res: Response) => {
    try {
