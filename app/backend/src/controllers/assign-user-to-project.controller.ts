...
import { AssignUserToProjectInput } from '../../../../domain/dist/use-cases/business/assign-user-to-project.use-case.js';

export const assignUserToProjectController = async (req: Request, res: Response) => {
    try {
        ...
        const input: AssignUserToProjectInput = { 
            actingUserId, 
            projectId,
            userIdToAssign
        };
