...
import { ListInvoicesByClientInput } from '../../../../domain/dist/use-cases/finance/list-invoices-by-client.use-case.js';

export const listInvoicesByClientController = async (req: Request, res: Response) => {
    try {
        ...
        const input: ListInvoicesByClientInput = { 
            actingUserId, 
            clientId 
        };
